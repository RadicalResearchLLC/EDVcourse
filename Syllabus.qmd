...
Assignments <- c('Group Project - data visualization', 'Individual project 1 - EJ tool remix', 
                'Individual Project 2 - written critique (minimum 2 pages)',
                'Individual Project 3 - data visualization',
                'Presentation on EJ tools',
                'Classroom participation',
                'Final exam', 'Extra Credit')
Points <- c(200, 100, 100, 100, 200, 100, 200, 50)
...
* A selection of Peer-review journal articles listed in the references below. [@hortonEnhancingOperationalValue2020, @kelleherTenGuidelinesEffective2011, @vanbeekEnvironmentalVisualizationFraming2020, , @gommehVisualDiscourseCoalitions2021, @murchieFundamentalsGraphicDesign2020, @graingerEnvironmentalDataVisualisation2016]
