...
Check the *Files* panel. Check for a new **CalEJ4** folder; @fig-codeUnzip shows how it looks on my machine.

![Another Shapefile folder is in the working directory!](/images/double.png){#fig-codeUnzip} 
