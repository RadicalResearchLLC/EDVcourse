...
2-Dimensional cartographic representations (i.e., maps) distort either [angles](https://map-projections.net/img/jpg/azimutal-equal-area-gpolar.jpg?ft=59bfd4f5), [distances](https://image4.slideserve.com/303535/all-projections-have-some-degree-of-distortion-l.jpg), or [sizes](https://kartoweb.itc.nl/geometrics/Bitmaps/Figure%204.19%20(scale%20distortion)a.gif)
...
::: {.callout-note appearance="important"}
![Read this!](http://www.scholarpedia.org/article/Visual_salience) focusing mostly on the pictures to get an impression of visual salience.   
:::
