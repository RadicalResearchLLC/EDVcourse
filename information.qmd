...
When we talk about the weather and use a data visualization, we are abstracting from @fig-actualweather to a 2-D representation of some numbers, colors, or pictures on a pixelized screen.  
