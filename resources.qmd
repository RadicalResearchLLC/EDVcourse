...
#remove the # in front of the install.packages to change this from a comment to code
...
Courtesy of Dalai - a [color palette cheatsheet](https://www.nceas.ucsb.edu/sites/default/files/2020-04/colorPaletteCheatsheet.pdf)
